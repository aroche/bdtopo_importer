...
SOURCES = \
	__init__.py \
	bdtopo_importer.py bdtopo_importer_dialog.py

PLUGINNAME = bdtopo_importer

PY_FILES = \
	__init__.py \
	bdtopo_importer.py bdtopo_importer_dialog.py

UI_FILES = bdtopo_importer_dialog_base.ui
...
QGISDIR=C:\Users\augustin.roche\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
